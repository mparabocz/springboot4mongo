...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, LocalDate.of(2026, 1, 1), "Exciting!",
				"I'm going out to investigate some rumors around my city. Wish me luck.", abraao);
		Post p2 = new Post(null, LocalDate.of(2025, 11, 30), "Beware.",
				"Beware of the old man in a profession where people die young.", abraao);
		Post p3 = new Post(null, LocalDate.of(2024, 9, 9), "Missing you", "You said you'd grow old with me.", braulio);
